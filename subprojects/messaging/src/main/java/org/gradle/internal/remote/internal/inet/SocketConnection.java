...
public class SocketConnection<T> implements RemoteConnection<T> {
    ...
    public T receive() throws MessageIOException {
        try {
            ...
            throw new MessageStreamException(String.format("Could not read message from '%s'.", remoteAddress), e);
        } catch (Exception e) {
    ...
    public void dispatch(T message) throws MessageIOException {
        try {
            ...
            throw new MessageStreamException(String.format("Could not write message %s to '%s'.", message, remoteAddress), e);
        } catch (Exception e) {
